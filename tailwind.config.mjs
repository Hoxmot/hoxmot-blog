...
export default {
  ...
  plugins: [
    require("@tailwindcss/typography"), // Nice to have for markdown, usually pre-included or needs install.
    // Note: If build fails, we might need to add this to package.json, but let's try standard first.
  ],
};
